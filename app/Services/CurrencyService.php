    ...
    */
    ...
    public function createCurrency($data, $user)
    {
        ...
        try {
            ...
            if(!$this->logAdminAction($user, 'Created Currency', 'Created '.$currency->displayName)) throw new \Exception("Failed to log admin action.");
    ...
    public function updateCurrency($currency, $data, $user)
    {
        ...
        try {
            ...
            if(!$this->logAdminAction($user, 'Updated Currency', 'Updated '.$currency->displayName)) throw new \Exception("Failed to log admin action.");
    ...
    public function deleteCurrency($currency, $user)
    {
        ...
        try {
            ...
            if(!$this->logAdminAction($user, 'Deleted Currency', 'Deleted '.$currency->name)) throw new \Exception("Failed to log admin action.");
