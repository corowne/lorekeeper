    ...
    */
    ...
    public function createCurrency($data, $user)
    {
        ...
        try {
            ...
            if(!logAdminAction($user, 'Created Currency', 'Created '.$currency->displayName)) throw new \Exception("Failed to log admin action.");
    ...
    public function updateCurrency($currency, $data, $user)
    {
        ...
        try {
            ...
            if(!logAdminAction($user, 'Updated Currency', 'Updated '.$currency->displayName)) throw new \Exception("Failed to log admin action.");
    ...
    public function deleteCurrency($currency, $user)
    {
        ...
        try {
            ...
            // if(DB::table('currencys')->where('data->resell', $currency->id)->exists()) throw new \Exception("An currency currently uses this currency for its resale value. Please change the resale information before deleting this currency.");
