    ...
    */
    ...
    public function deleteCurrency($currency)
    {
        ...
        try {
            ...
            if(DB::table('items')->where('data.resell', $currency->id)->exists()) throw new \Exception("An item currently uses this currency for its resale value. Please change the resale information before deleting it.");
