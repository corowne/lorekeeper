...
@section('home-title') Full Inventory @endsection
							...
							<li>
								...
								@else
									@foreach($characters as $char)
										...
										@endif
									@endforeach
									<a class="invchar" data-id="{{ $item->pivot->id }}" data-name="{{ $charaname }}'s {{ $item->name }}" href="#">Stack</a> of x{{ $item->pivot->count }} in <a href="{{ $charalink }}">{{ $charaname }}</a>'s inventory.
								@endif
							</li>
						@endforeach
					</ul>
