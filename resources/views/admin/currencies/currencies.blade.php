...
<div class="mb-4 logs-table">
    <div class="logs-table-header">
        <div class="row">
            <div class="col-12 col-md-4"><div class="logs-table-cell">Name</div></div>
            <div class="col-4 col-md-4"><div class="logs-table-cell">Displays As</div></div>
            <div class="col-4 col-md-3"><div class="logs-table-cell">Attaches To</div></div>
        </div>
    </div>
        ...
        @foreach($currencies as $currency)
            <div class="logs-table-row">
                <div class="row flex-wrap">
                    <div class="col-12 col-md-4 "><div class="logs-table-cell">{{ $currency->name }} @if($currency->abbreviation) ({{ $currency->abbreviation }}) @endif</div></div>
                    <div class="col-4 col-md-4"><div class="logs-table-cell">{!! $currency->display(100) !!}</div></div>
                    <div class="col-4 col-md-3"><div class="logs-table-cell">{{ $currency->is_user_owned ? 'User' : '' }} {{ ($currency->is_character_owned && $currency->is_user_owned) ? '+' : '' }} {{ $currency->is_character_owned ? 'Character' : '' }}</div></div>
                    <div class="col-4 col-md-1"><div class="logs-table-cell"><a href="{{ url('admin/data/currencies/edit/'.$currency->id) }}" class="btn btn-primary">Edit</a></div></div>
                </div>
            </div>
        @endforeach
    </div>
