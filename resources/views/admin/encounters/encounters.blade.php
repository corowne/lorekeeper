...
<div class="text-right mb-3">
    <a class="btn btn-primary" href="{{ url('admin/data/encounters/create') }}"><i class="fas fa-plus"></i> Create New Encounter</a>
</div>
...
@else
    ...
    <div class="text-center mt-4 small text-muted">{{ $encounters->total() }} result{{ $encounters->total() == 1 ? '' : 's' }} found.</div>
@endif
