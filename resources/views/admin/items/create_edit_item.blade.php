...
@section('admin-content')
    ...
    <div class="row">
        ...
        <div class="col-md form-group">
            ...
            {!! Form::label('is_deletable', 'Can Be Deleted', ['class' => 'form-check-label ml-3']) !!} {!! add_help('If this is off, users will not be able to delete the item from their or their character's inventory.') !!}
        </div>
    </div>
