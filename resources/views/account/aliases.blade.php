...
<div class="mb-4 logs-table">
    <div class="logs-table-header">
        <div class="row">
            <div class="col-3"><div class="logs-table-cell">Alias</div></div>
            <div class="col-3"><div class="logs-table-cell">Site</div></div>
            <div class="col-1"><div class="logs-table-cell"></div></div>
        ...
        @foreach(Auth::user()->aliases()->orderBy('is_primary_alias', 'DESC')->orderBy('site')->get() as $alias)
            <div class="logs-table-row">
                <div class="row flex-wrap">
                    <div class="col-3"><div class="logs-table-cell"><a href="{{ $alias->url }}">{{ $alias->alias }}</a></div></div>
                    <div class="col-3">
