...
@section('content')
    ...
    <div class="extensions row no-gutters">
        ...
        <p class="mb-0 col-md-4">
            ...
            ({{ Config::get('lorekeeper.extensions.character_reward_expansion.expanded') ? 'Enabled' : 'Disabled' }}/{{ Config::get('lorekeeper.extensions.character_reward_expansion.default_recipient') ? 'Submitter' : 'Character Owner' }})
        </p>
        <p class="mb-0 col-md-4">
            ...
            ({{ Config::get('lorekeeper.extensions.character_status_badges') ? 'Enabled' : 'Disabled' }})
        </p>
        <p class="mb-0 col-md-4">
        ...
        <p class="mb-0 col-md-4">
            ...
            ({{ Config::get('lorekeeper.extensions.item_entry_expansion.extra_fields') ? 'Enabled' : 'Disabled' }}/{{ Config::get('lorekeeper.extensions.item_entry_expansion.resale_function') ? 'Enabled' : 'Disabled' }})
        </p>
        <p class="mb-0 col-md-4">
        ...
        <p class="mb-0 col-md-4">
            ...
            ({{ Config::get('lorekeeper.extensions.navbar_news_notif') ? 'Enabled' : 'Disabled' }})
        </p>
        <p class="mb-0 col-md-4">
        ...
        <p class="mb-0 col-md-4">
            ...
            ({{ Config::get('lorekeeper.extensions.species_trait_index.enable') ? 'Enabled' : 'Disabled' }})
        </p>
        <p class="mb-0 col-md-4">
