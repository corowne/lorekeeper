        ...
        <div class="card-body tab-content">
            ...
            <div class="tab-pane fade show active" id="info-{{ $image->id }}">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-6 col-8">{!! $image->species_id ? $image->species->displayName : 'None' !!}{{ $image->species_id && $image->species->hasDrops ? ' ('.$character->drops->parameters.')' : '' }}</div>
                </div>
                @if($image->subtype_id)
                    <div class="row">
