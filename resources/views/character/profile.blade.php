...
{{-- Bio --}}
<a class="float-left" href="{{ url('reports/new?url=') . $character->url }}"><i class="fas fa-exclamation-triangle" data-toggle="tooltip" title="Click here to report this character's profile." style="opacity: 50%;"></i></a>
